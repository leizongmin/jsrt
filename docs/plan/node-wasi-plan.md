...
:PHASE3_SYSCALLS: 🔵 IN_PROGRESS - 4/12 critical syscalls implemented (33%)
:PHASE3_IMPLEMENTED: args_get, args_sizes_get, environ_get, environ_sizes_get, fd_write
