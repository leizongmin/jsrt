...
function responseMethodsTest() {
  ...
  console.log('- text():', typeof response.text === 'function' ? 'Function exists' : 'Function missing');
  console.log('- json():', typeof response.json === 'function' ? 'Function exists' : 'Function missing');
  console.log('- arrayBuffer():', typeof response.arrayBuffer === 'function' ? 'Function exists' : 'Function missing');
  console.log('- blob():', typeof response.blob === 'function' ? 'Function exists' : 'Function missing');
}
...
function headersTest() {
  ...
  console.log('Case-insensitive get (content-type):', headers.get('content-type'));
  console.log('Case-insensitive has (AUTHORIZATION):', headers.has('AUTHORIZATION'));
  console.log('Custom header:', headers.get('X-Custom-Header'));
  
  // Test deletion
  headers.delete('X-Custom-Header');
  console.log('After deletion, has custom header:', headers.has('X-Custom-Header'));
