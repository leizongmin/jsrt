...
async function testResponseMethods() {
  ...
  console.log('✅ text() returns:', typeof textPromise, textPromise.constructor.name);
  console.log('✅ json() returns:', typeof jsonPromise, jsonPromise.constructor.name);
  console.log('✅ arrayBuffer() returns:', typeof arrayBufferPromise, arrayBufferPromise.constructor.name);
  console.log('✅ blob() returns:', typeof blobPromise, blobPromise.constructor.name);
  ...
  try {
    ...
    console.log('arrayBuffer() resolved with:', buffer.constructor.name, 'size:', buffer.byteLength);
  } catch (error) {
...
function testFetch() {
  ...
  console.log('fetch() returns:', typeof fetchPromise, fetchPromise.constructor.name);
  ...
  console.log('fetch() with options returns:', typeof fetchWithOptions, fetchWithOptions.constructor.name);
}
