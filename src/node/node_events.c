...
static JSValue js_event_emitter_prepend_listener(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv) {
  if (argc < 2) {
...
static JSValue js_event_emitter_prepend_once_listener(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv) {
  if (argc < 2) {
    return node_throw_error(ctx, NODE_ERR_MISSING_ARGS, "prependOnceListener() requires event name and listener function");
  }
...
static JSValue js_event_emitter_event_names(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv) {
  if (!is_event_emitter(ctx, this_val)) {
    return node_throw_error(ctx, NODE_ERR_INVALID_ARG_TYPE, "this is not an EventEmitter");
  }
...
static JSValue js_event_emitter_listeners(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv) {
  if (argc < 1) {
...
static JSValue js_event_emitter_raw_listeners(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv) {
...
static JSValue js_event_emitter_off(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv) {
  return js_event_emitter_remove_listener(ctx, this_val, argc, argv);
}

// Helper: Get or create _maxListeners property
static JSValue get_or_create_max_listeners(JSContext* ctx, JSValueConst this_val) {
...
static JSValue js_event_emitter_set_max_listeners(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv) {
  if (argc < 1) {
...
static JSValue js_event_emitter_get_max_listeners(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv) {
  if (!is_event_emitter(ctx, this_val)) {
...
JSValue JSRT_InitNodeEvents(JSContext* ctx) {
  ...
  JS_SetPropertyStr(ctx, prototype, "eventNames",
                    JS_NewCFunction(ctx, js_event_emitter_event_names, "eventNames", 0));
  JS_SetPropertyStr(ctx, prototype, "listeners",
                    JS_NewCFunction(ctx, js_event_emitter_listeners, "listeners", 1));
  JS_SetPropertyStr(ctx, prototype, "rawListeners",
                    JS_NewCFunction(ctx, js_event_emitter_raw_listeners, "rawListeners", 1));
  JS_SetPropertyStr(ctx, prototype, "off",
                    JS_NewCFunction(ctx, js_event_emitter_off, "off", 2));
