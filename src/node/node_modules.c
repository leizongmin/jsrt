...
static NodeModuleEntry node_modules[] = {
    ...
    {"util", JSRT_InitNodeUtil, js_node_util_init, NULL, false},
    // {"querystring", NULL, NULL, NULL, false},

    // Building blocks - to be implemented later
    {"events", JSRT_InitNodeEvents, js_node_events_init, NULL, false},
    {"buffer", JSRT_InitNodeBuffer, js_node_buffer_init, NULL, false},
    // {"process", JSRT_InitNodeProcess, NULL, NULL, false},

    // I/O modules - to be implemented later
    {"stream", JSRT_InitNodeStream, js_node_stream_init, stream_deps, false},
    {"fs", JSRT_InitNodeFs, js_node_fs_init, fs_deps, false},

    // Networking modules
    {"net", JSRT_InitNodeNet, js_node_net_init, net_deps, false},
    {"http", JSRT_InitNodeHttp, js_node_http_init, http_deps, false},
    {"https", JSRT_InitNodeHttps, js_node_https_init, https_deps, false},
    {"dns", JSRT_InitNodeDns, js_node_dns_init, NULL, false},
