...
static const char* tty_deps[] = {"events", "stream", NULL};

static JSValue js_node_http2_server_request_ctor(JSContext* ctx, JSValueConst new_target, int argc,
                                                 JSValueConst* argv) {
  return JS_UNDEFINED;
}

JSValue JSRT_InitNodeHttp2(JSContext* ctx) {
  JSValue http2_obj = JS_NewObject(ctx);
  JSValue ctor =
      JS_NewCFunction2(ctx, js_node_http2_server_request_ctor, "Http2ServerRequest", 1, JS_CFUNC_constructor, 0);

  // Create and set prototype for instanceof checks
  JSValue prototype = JS_NewObject(ctx);
  JS_SetPropertyStr(ctx, ctor, "prototype", prototype);

  JS_SetPropertyStr(ctx, http2_obj, "Http2ServerRequest", ctor);
  return http2_obj;
}

int js_node_http2_init(JSContext* ctx, JSModuleDef* m) {
  JSValue http2_obj = JSRT_InitNodeHttp2(ctx);

  JSValue ctor = JS_GetPropertyStr(ctx, http2_obj, "Http2ServerRequest");
  JS_SetModuleExport(ctx, m, "Http2ServerRequest", JS_DupValue(ctx, ctor));
  JS_FreeValue(ctx, ctor);

  JS_SetModuleExport(ctx, m, "default", JS_DupValue(ctx, http2_obj));
  JS_FreeValue(ctx, http2_obj);
  return 0;
}
...
static NodeModuleEntry node_modules[] = {
    ...
    {"module", JSRT_InitNodeModule, js_node_module_init, NULL, false, {0}},
    {"resolve", JSRT_InitResolve, js_resolve_init, NULL, false, {0}},
    ...
    {"timers", JSRT_InitNodeTimers, js_node_timers_init, NULL, false, {0}},
    {"timers/promises", JSRT_InitNodeTimersPromises, js_node_timers_promises_init, NULL, false, {0}},
    {"async_hooks", JSRT_InitNodeAsyncHooks, js_node_async_hooks_init, NULL, false, {0}},
    {"domain", JSRT_InitNodeDomain, js_node_domain_init, NULL, false, {0}},
    {"worker_threads", JSRT_InitNodeWorkerThreads, js_node_worker_threads_init, NULL, false, {0}},
    ...
    {"fs/promises", JSRT_InitNodeFsPromises, js_node_fs_promises_init, fs_deps, false, {0}},
    ...
    {"http2", JSRT_InitNodeHttp2, js_node_http2_init, http_deps, false, {0}},
    {"dns", JSRT_InitNodeDns, js_node_dns_init, NULL, false, {0}},
    {"dns/promises", JSRT_InitNodeDnsPromises, js_node_dns_promises_init, NULL, false, {0}},
    ...
    // Process management
    {"child_process", JSRT_InitNodeChildProcess, js_node_child_process_init, child_process_deps, false, {0}},

    // WebAssembly modules
    {"wasi", JSRT_InitNodeWASI, js_node_wasi_init, NULL, false, {0}},

    // Terminal I/O module
    {"tty", JSRT_InitNodeTTY, js_node_tty_init, tty_deps, false, {0}},

    // Critical missing modules for npm compatibility
    {"vm", JSRT_InitNodeVM, js_node_vm_init, NULL, false, {0}},
    {"constants", JSRT_InitNodeConstants, js_node_constants_init, NULL, false, {0}},
    {"string_decoder", JSRT_InitNodeStringDecoder, js_node_string_decoder_init, NULL, false, {0}},
    {"diagnostics_channel", JSRT_InitNodeDiagnosticsChannel, js_node_diagnostics_channel_init, NULL, false, {0}},
    {"readline", JSRT_InitNodeReadline, js_node_readline_init, NULL, false, {0}},
    {"tls", JSRT_InitNodeTls, js_node_tls_init, net_deps, false, {0}},
...
JSModuleDef* JSRT_LoadNodeModule(JSContext* ctx, const char* module_name) {
  ...
  if (m) {
    ...
    if (strcmp(module_name, "path") == 0) {
      ...
      JS_AddModuleExport(ctx, m, "default");
    } else if (strcmp(module_name, "resolve") == 0) {
      JS_AddModuleExport(ctx, m, "sync");
      JS_AddModuleExport(ctx, m, "isCore");
      JS_AddModuleExport(ctx, m, "default");
      ...
      JS_AddModuleExport(ctx, m, "Socket");
      JS_AddModuleExport(ctx, m, "default");
    } else if (strcmp(module_name, "child_process") == 0) {
      ...
      JS_AddModuleExport(ctx, m, "globalAgent");
      JS_AddModuleExport(ctx, m, "default");
    } else if (strcmp(module_name, "http2") == 0) {
      JS_AddModuleExport(ctx, m, "Http2ServerRequest");
      JS_AddModuleExport(ctx, m, "default");
      ...
      JS_AddModuleExport(ctx, m, "default");
    } else if (strcmp(module_name, "dns/promises") == 0) {
      JS_AddModuleExport(ctx, m, "lookup");
      JS_AddModuleExport(ctx, m, "lookupService");
      JS_AddModuleExport(ctx, m, "default");
      ...
      JS_AddModuleExport(ctx, m, "default");
    } else if (strcmp(module_name, "vm") == 0) {
      JS_AddModuleExport(ctx, m, "Script");
      JS_AddModuleExport(ctx, m, "createContext");
      JS_AddModuleExport(ctx, m, "createScript");
      JS_AddModuleExport(ctx, m, "default");
    } else if (strcmp(module_name, "constants") == 0) {
      ...
      JS_AddModuleExport(ctx, m, "default");
    } else if (strcmp(module_name, "string_decoder") == 0) {
      JS_AddModuleExport(ctx, m, "StringDecoder");
      JS_AddModuleExport(ctx, m, "default");
    } else if (strcmp(module_name, "diagnostics_channel") == 0) {
      JS_AddModuleExport(ctx, m, "channel");
      JS_AddModuleExport(ctx, m, "hasSubscribers");
      JS_AddModuleExport(ctx, m, "publish");
      JS_AddModuleExport(ctx, m, "subscribe");
      JS_AddModuleExport(ctx, m, "unsubscribe");
      JS_AddModuleExport(ctx, m, "bindSymbol");
      JS_AddModuleExport(ctx, m, "default");
    } else if (strcmp(module_name, "readline") == 0) {
      JS_AddModuleExport(ctx, m, "createInterface");
      JS_AddModuleExport(ctx, m, "createCompleter");
      JS_AddModuleExport(ctx, m, "clearLine");
      JS_AddModuleExport(ctx, m, "clearScreenDown");
      JS_AddModuleExport(ctx, m, "cursorTo");
      JS_AddModuleExport(ctx, m, "moveCursor");
      JS_AddModuleExport(ctx, m, "default");
    } else if (strcmp(module_name, "tls") == 0) {
      JS_AddModuleExport(ctx, m, "connect");
      JS_AddModuleExport(ctx, m, "createServer");
      JS_AddModuleExport(ctx, m, "createSecureContext");
      JS_AddModuleExport(ctx, m, "rootCertificates");
      JS_AddModuleExport(ctx, m, "checkServerIdentity");
      JS_AddModuleExport(ctx, m, "TLSSocket");
      JS_AddModuleExport(ctx, m, "DEFAULT_CIPHERS");
      JS_AddModuleExport(ctx, m, "DEFAULT_ECDH_CURVE");
      JS_AddModuleExport(ctx, m, "constants");
      JS_AddModuleExport(ctx, m, "default");
    }
...
const char* JSRT_GetNodeModuleName(int index) {
  if (index < 0 || index >= JSRT_GetNodeModuleCount()) {
    return NULL;
  }
  return node_modules[index].name;
}
