...
static inline size_t JSRT_ListLength(JSRT_List *list) { return list->length; }

static inline bool JSRT_ListIsEmpty(JSRT_List *list) { return list->length == 0; }

static inline void *JSRT_ListHead(JSRT_List *list) { return list->head->data; }

static inline void *JSRT_ListTail(JSRT_List *list) { return list->tail->data; }
