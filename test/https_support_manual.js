...
try {
  ...
  assert.strictEqual(typeof httpsPromise, 'object', 'HTTPS should return promise');
  assert.strictEqual(typeof httpsPromise.then, 'function', 'HTTPS promise should have then method');
...
try {
  ...
  assert.strictEqual(typeof httpPromise.then, 'function', 'HTTP promise should have then method');
...
try {
  ...
  assert.strictEqual(typeof httpsCustom, 'object', 'HTTPS custom port should work');
  assert.strictEqual(typeof httpCustom, 'object', 'HTTP custom port should work');
...
try {
  ...
  assert.strictEqual(typeof ftpPromise, 'object', 'Should create promise even for invalid protocols');
