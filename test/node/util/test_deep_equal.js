...
assert.strictEqual(
  util.isDeepStrictEqual('test', 'test'),
  true,
  'strings equal'
);
...
assert.strictEqual(
  util.isDeepStrictEqual({ a: 1 }, { b: 1 }),
  false,
  'Different keys'
);
assert.strictEqual(
  util.isDeepStrictEqual({ a: 1 }, { a: 1, b: 2 }),
  false,
...
assert.strictEqual(
  util.isDeepStrictEqual([1, 2, 3], [1, 3, 2]),
  false,
  'Different order'
);
assert.strictEqual(
...
assert.strictEqual(
  util.isDeepStrictEqual(null, undefined),
  false,
  'null !== undefined'
);
