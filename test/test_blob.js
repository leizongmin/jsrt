...
assert.strictEqual(blob3.type, 'text/plain', 'Blob type should be set correctly');
...
assert.strictEqual(sliced.size, 5n, 'Sliced blob should have correct size');
  ...
  assert.strictEqual(typeof buffer, 'object', 'arrayBuffer() should return an object');
  assert.strictEqual(buffer.byteLength, 11, 'arrayBuffer() should have correct byte length');
