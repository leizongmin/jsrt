...
try {
  ...
  console.log(
    '✓ Array argument processing implemented (conversion happens during function calls)'
  );
} catch (error) {
...
console.log(
  '- JavaScript arrays can be passed to C functions (converted to native arrays)'
);
console.log(
  '- C arrays can be converted back to JavaScript arrays with arrayFromPointer()'
);
