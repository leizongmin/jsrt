...
assert.strictEqual(formData.has("name"), true, 'FormData should have "name" field');
console.log("Has 'email':", formData.has("email"));
assert.strictEqual(formData.has("email"), false, 'FormData should not have "email" field');
console.log("✓ FormData.has() works");

// Test get()
console.log("Get 'name':", formData.get("name"));
assert.strictEqual(formData.get("name"), "John", 'FormData should return correct value');
console.log("Get 'nonexistent':", formData.get("nonexistent"));
assert.strictEqual(formData.get("nonexistent"), null, 'FormData should return null for nonexistent field');
...
assert.strictEqual(Array.isArray(hobbies), true, 'getAll should return an array');
...
assert.strictEqual(typeof fileValue, 'object', 'File value should be an object');
