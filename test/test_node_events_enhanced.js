...
emitter.prependOnceListener('prepend-once-test', () =>
  onceCallOrder.push('prepend-once')
);
...
assert.strictEqual(
  maxListenersEmitter.getMaxListeners(),
  10,
...
integrationEmitter.prependListener('integration', () =>
