...
assert.strictEqual(path.resolve('/foo/bar', '../baz'), path.sep + 'foo' + path.sep + 'baz');
...
// Test path.basename
assert.strictEqual(path.basename(path.sep + 'a' + path.sep + 'b' + path.sep + 'c.txt'), 'c.txt');
assert.strictEqual(path.basename(path.sep + 'a' + path.sep + 'b' + path.sep + 'c.txt', '.txt'), 'c');
assert.strictEqual(path.basename(path.sep + 'a' + path.sep + 'b' + path.sep), 'b');
