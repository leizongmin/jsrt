...
console.log("Test 1: WebAssembly global object");
...
assert.ok(typeof WebAssembly.validate === "function", "WebAssembly.validate should be a function");
...
assert.ok(typeof WebAssembly.Module === "function", "WebAssembly.Module should be a constructor");
...
assert.ok(typeof WebAssembly.Instance === "function", "WebAssembly.Instance should be a constructor");
