...
function testRSASSAPKCS1v15KeyGeneration() {
  ...
  return crypto.subtle.generateKey(
    ...
    assert.strictEqual(keyPair.publicKey.algorithm.name, 'RSASSA-PKCS1-v1_5', 'Algorithm name should be RSASSA-PKCS1-v1_5');
...
function testRSASSAPKCS1v15Signature(keyPair) {
  ...
  return crypto.subtle.sign(
    ...
    console.log('✓ RSASSA-PKCS1-v1_5 signature successful, signature length:', signature.byteLength);
    ...
    console.error('✗ RSASSA-PKCS1-v1_5 signature/verification test FAILED:', error);
    throw error;
  });
}
...
function testRSASSAPKCS1v15InvalidSignature(keyPair) {
  ...
  return crypto.subtle.sign(
    ...
    console.log('✓ RSASSA-PKCS1-v1_5 verification result for tampered data:', isValid);
    ...
    console.error('✗ RSASSA-PKCS1-v1_5 invalid signature test FAILED:', error);
    throw error;
  });
}
    ...
    promise = promise.then(function() {
      ...
      return crypto.subtle.generateKey(
        ...
        return crypto.subtle.sign(
          ...
          assert.strictEqual(isValid, true, 'Signature should be valid for ' + hash);
        });
      });
    });
  });
...
function runTests() {
  ...
  testRSASSAPKCS1v15KeyGeneration().then(function(keyPair) {
